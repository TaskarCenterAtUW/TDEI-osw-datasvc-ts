...
export class UploadCompressionOSMRequestWorkflow extends WorkflowBase {

    constructor(workflowEvent: EventEmitter, orchestratorServiceInstance: IOrchestratorService) {
        super(workflowEvent, orchestratorServiceInstance, "OSW_UPLOAD_COMPRESSION_OSM_REQUEST_WORKFLOW");
    }
    ...
    async handleWorkflow(message: QueueMessage, params: any): Promise<void> {
        ...
        try {
            ...
            let input_urls = [dataset.latest_osm_url, dataset.metadata_url];
            ...
            let output_path = directory + '/zip/'+dataset.tdei_dataset_id+'.osm.zip';
