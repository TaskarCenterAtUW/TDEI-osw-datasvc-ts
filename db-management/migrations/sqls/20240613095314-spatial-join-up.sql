...
IF source_element = 'edge' THEN
	...
	FOR temp_row IN
	    ...
	    WHERE z.tdei_dataset_id = source_dataset_id
	...
	FOR temp_row IN
        ...
        WHERE n.tdei_dataset_id = source_dataset_id
...
IF source_element = 'node' THEN
	...
	WHERE e.tdei_dataset_id = source_dataset_id
