...
--   SELECT * FROM content.tdei_dataset_spatial_join(
--     'fa8e12ea-6b0c-4d3e-8b38-5b87b268e76b',
--     'SELECT r.edge_id, r.orig_node_id, r.dest_node_id, r.edge_loc, jsonb_set(
--         r.feature::jsonb, 
--         ''{properties}'', 
--         r.feature::jsonb->''properties'' || jsonb_build_object(
--             ''ext:S_highway'', array_agg(s.highway),
--             ''ext:new_property1'', ''value1''
--         ), 
--         true
--     )::json AS feature
--     FROM content.edge r
--     INNER JOIN content.extension_point s on 
--     ST_Intersects( 
--     ST_Buffer(ST_Transform(r.edge_loc, 3857), 5, ''endcap=flat''), ST_Transform(s.point_loc, 3857)
--     )
--     WHERE
--     r.tdei_dataset_id = ''fa8e12ea-6b0c-4d3e-8b38-5b87b268e76b''
--     AND s.tdei_dataset_id = ''0d661b69495d47fb838862edf699fe09''
--     AND r.highway = ''footway''
--     AND r.footway = ''sidewalk''
--     AND s.highway = ''street_lamp''
--     GROUP BY r.edge_id,r.orig_node_id, r.dest_node_id, r.edge_loc, s.highway,r.feature::jsonb',
--     'edge'
-- );
