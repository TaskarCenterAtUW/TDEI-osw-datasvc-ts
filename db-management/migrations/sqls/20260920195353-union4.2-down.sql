...
-- Remove the entity_filters overload added by the up migration, otherwise it
-- would coexist with the restored three-argument function and make calls
-- ambiguous.
DROP FUNCTION IF EXISTS content.tdei_union_dataset(CHARACTER VARYING, CHARACTER VARYING, REAL, JSONB);
