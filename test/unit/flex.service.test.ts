...
describe("Flex Service Test", () => {
    ...
    describe('process publish request', () => {
        ...
        it('should process publish request successfully', async () => {
            ...
            // Call the function
            const result = await flexService.processPublishRequest(userId, tdeiRecordId);
            ...
            expect(
              workflowDatabaseService.obseleteAnyExistingWorkflowHistory
            ).toHaveBeenCalledWith(tdeiRecordId, "");
        });
    });
